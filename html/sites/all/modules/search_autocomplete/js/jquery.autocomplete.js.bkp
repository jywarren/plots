...
(function($) {
    ...
    /**
     * Autocompleter class
     * @param {o/ject} $elem jQuery object with one input tag
    ...
    $.Autocompleter.prototype.parseRemoteData = function(remoteData) {
        ...
        if (this.options.remoteDataType === 'json') {
            ...
            switch (remoteDataType) {
                case 'object': 
			// an object doesn't have object.length, breaking later for loops
			data = []
			$.each(Object.keys(remoteData), function(i,key) {
				var row = {}
				row['value'] = remoteData[key]
				data.push(row)
			})
                    break;
                case 'string':
