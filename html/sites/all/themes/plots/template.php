 ...
 *   entirety and paste it here, changing the prefix from theme_ to plots_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: plots_breadcrumb()
 *
 *   where plots is the name of your sub-theme. For example, the
 ...
 */
function plots_theme(&$existing, $type, $theme, $path) {
...
function plots_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function plots_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function plots_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // plots_preprocess_node_page() or plots_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function plots_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function plots_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
